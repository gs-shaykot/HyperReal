...
export const Banner = () => {
    ...
    return (
        <div className={`${theme === 'light' ? 'bg-main/80 border-zinc-800' : 'bg-white border-zinc-400'} relative overflow-hidden border-b`}>
            <div
                className={`${theme === 'light' ? 'opacity-20' : 'opacity-10'} absolute inset-0 `}
                style={{
            ...
            <div className="relative z-10 flex flex-col items-center justify-center px-4 py-8 md:py-14 lg:py-16 space-y-3">
                <p className={`border p-2 text-sm font-mono tracking-wider ${theme === 'light' ? 'text-second border-zinc-800' : 'text-zinc-900 border-second'}`}>
                    • SYSTEM ONLINE // V.4.0
                </p>
                ...
                <div className='flex flex-col justify-center items-center space-y-3'>
                    ...
                    <p className={`w-10/12 md:w-8/12 lg:w-6/12 text-center text-sm md:text-base ${theme === 'light' ? 'text-white' : 'text-zinc-900'}`}>The new collection features technical fabrics, oversized silhouettes, and experimental dyes designed for the urban nomad.</p>
                </div>
