...
export const Upcoming = () => {
    ...
    return (
        <section className='w-full py-10 bg-second flex items-center justify-center'>
            <div className='max-w-7xl w-full h-full mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-5'>
                <div className='flex flex-col items-start justify-center space-y-3'>
                    ...
                    <h1 className='text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold font-inter!'>
                    ...
                    <p className='w-full md:w-10/12 text-zinc-900 font-bold'>
