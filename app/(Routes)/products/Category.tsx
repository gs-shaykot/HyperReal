                    ...
                    return (
                        <li key={category.id}>
                            <button
                                ...
                                className={`${activeCategoryClass(categoryId === category.id)} 
                                text-xs md:text-base border lg:border-0 p-1 lg:p-0 
                                cursor-pointer hover:text-second lg:hover:translate-x-1 
