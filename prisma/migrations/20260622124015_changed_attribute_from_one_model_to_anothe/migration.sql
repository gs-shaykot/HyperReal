/*
  ...
  - Added the required column `totalAmountInUSD` to the `Payment` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "totalAmountInUSD" DOUBLE PRECISION NOT NULL;
